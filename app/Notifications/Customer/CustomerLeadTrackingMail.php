...
class CustomerLeadTrackingMail extends Notification implements ShouldQueue
{
    ...
    public function toTwilio(object $notifiable)
    {
        ...
        $message .= "$route\n\n";
        $message .= "This link will provide you with a convenient platform to review your information and upload any necessary documents. Please ensure to complete this process by " . Carbon::createFromTimestamp($this->params['expires'])->format('Y-m-d H:i:s') . " as the link will expire after this time.\n\n";
